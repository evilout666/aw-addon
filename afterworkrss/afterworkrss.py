...
class PlayerView(discord.ui.View):
    def __init__(self, cog: commands.Cog, is_playing: bool = False):
        ...
        song_button = discord.ui.Button(label="Song", style=discord.ButtonStyle.primary, custom_id="player_song", row=0)
        ...
        skip_button = discord.ui.Button(label="Next", style=discord.ButtonStyle.success, custom_id="player_skip", row=0)
        skip_button.callback = self.on_skip
        self.add_item(skip_button)

        stop_button = discord.ui.Button(label="Stop", style=discord.ButtonStyle.danger, custom_id="player_stop", row=0)
